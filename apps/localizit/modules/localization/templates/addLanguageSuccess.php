<div class="outerBorder homePageBorder">
    <div class="homePage">
        <div class="mediumText pageHeader">
            <?php echo __('new_language', null, 'localizationMessages') ?>
        </div>
        <form action="<?php echo url_for('@add_language'); ?>" method="post" id="add_language_form" name="add_language_form">
            ...
            <input type="button" name="save_language" id="save_language" class="button normalText" value="<?php echo __('save', null, 'localizationMessages') ?>" />
