...
CREATE TABLE ohrm_user (id BIGINT AUTO_INCREMENT, firstname VARCHAR(250) NOT NULL, lastname VARCHAR(250) NOT NULL, email VARCHAR(250) NOT NULL, username VARCHAR(250) NOT NULL, user_type_id BIGINT NOT NULL, password VARCHAR(250), INDEX user_type_id_idx (user_type_id), PRIMARY KEY(id)) ENGINE = INNODB;
